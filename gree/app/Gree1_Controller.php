...
require_once 'Gree1_Error.php';
require_once 'Gree1_ActionClass.php';
require_once 'Gree1_ActionForm.php';
require_once 'Gree1_ViewClass.php';

/**
 *  Gree1 application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Gree1
 */
class Gree1_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $class = array(
        ...
        'form'          => 'Gree1_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Gree1_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Gree1_UrlHandler',
    );
