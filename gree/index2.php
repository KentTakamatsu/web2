...
<input type="hidden" id="first_scenario_file" value="http://msyoka.jp/gree/data/scenario/minigame/mini_scene1.ks">
...
$gid = $_SESSION["gid"];
$sql = $PDO->prepare("UPDATE game1 SET energy = energy-20 WHERE :gId LIMIT 1");
